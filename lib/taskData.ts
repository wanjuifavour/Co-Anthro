...
import { formatHackathonDayLabel } from '@/lib/time'
...
export const DAYS: Day[] = [
  {
    date: formatHackathonDayLabel(4, 2), label: 'Brainstorm', phase: 'plan',
    tasks: [
      ...
      { who: 'ALL', title: 'Brainstorm product ideas (60 min timebox)', detail: 'Each person brings 2 ideas. Use the instructions shared earlier as a springboard. No criticism yet.' },
      ...
      { who: 'ALL', title: 'Confirm team roles', detail: `${getTeamMemberName('A')} = Product lead + presenter. ${getTeamMemberName('B')} = Lead builder (AI/backend). ${getTeamMemberName('C')} = Design + user research + deck support.` },
    ]
  },
  {
    date: formatHackathonDayLabel(4, 3), label: 'Decide', phase: 'plan',
    tasks: [
  ...
  {
    date: formatHackathonDayLabel(4, 4), label: 'Spec', phase: 'spec',
    tasks: [
  ...
  {
    date: formatHackathonDayLabel(4, 5), label: 'Spec done', phase: 'spec',
    tasks: [
  ...
  {
    date: formatHackathonDayLabel(4, 6), label: 'Build 1', phase: 'build',
    tasks: [
  ...
  {
    date: formatHackathonDayLabel(4, 7), label: 'Build 1 done', phase: 'build',
    tasks: [
  ...
  {
    date: formatHackathonDayLabel(4, 8), label: 'Build 2', phase: 'build',
    tasks: [
  ...
  {
    date: formatHackathonDayLabel(4, 9), label: 'Build 2 done', phase: 'build',
    tasks: [
  ...
  {
    date: formatHackathonDayLabel(4, 10), label: 'Final polish', phase: 'polish',
    tasks: [
  ...
  {
    date: formatHackathonDayLabel(4, 11), label: 'Pitch day', phase: 'pitch',
    tasks: [
...
export const WHO_META: Record<string, { label: string; sub: string; bg: string; border: string; text: string }> = {
  A: { label: getTeamMemberName('A'), sub: 'Product + Presenter', bg: '#EEEDFE', border: '#AFA9EC', text: '#3C3489' },
  B: { label: getTeamMemberName('B'), sub: 'Lead Builder', bg: '#E1F5EE', border: '#5DCAA5', text: '#085041' },
  C: { label: getTeamMemberName('C'), sub: 'Design + Research', bg: '#FAECE7', border: '#F0997B', text: '#712B13' },
